function handleWriteDown(canvasRef, e, currentShape, setCurrentShape, shape, setShape, allshapes, setAllshapes, font, setFont, offsetX, offsetY, zoomLevel) {
  // console.log("called")
  ...
  setFont(newfontSize);
  let virtualX = e.clientX / zoomLevel + offsetX;
  let virtualY = e.clientY / zoomLevel + offsetY;
