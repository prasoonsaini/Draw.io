async function handleSelectUp(canvasRef, isDragging, setIsDragging, setDraggingIndex, setIsResizing, setResizingIndex, isResizing, panning, setPanning, allshapes) {
    if (isDragging) {
        // Stop dragging
        setIsDragging(false);
