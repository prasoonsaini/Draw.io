...
function ShareWidget({ user, sessionActive, setSessionActive, setUser, socket, setSocket, setShareWidgetRef }) {
    ...
    // )
    const handleCopy = () => {
        navigator.clipboard.writeText(`https://draw-io-flame.vercel.app/user=${user}/session=${sessionToken}`);
    ...
    return (
        ...
        >
            ...
            >
                <TextField
                    value={`https://draw-io-flame.vercel.app/user=${user}/session=${sessionToken}`}
                    InputProps={{
                        readOnly: true,
                    }}
                    multiline
