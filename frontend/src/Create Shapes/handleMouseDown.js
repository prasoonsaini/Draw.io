...
const handleMouseDown = (canvasRef, e, setIsDrawing, setCurrentShape, shape, setShape, offsetX, offsetY, zoomLevel) => {
    ...
    if (shape === 'rec') {
        ...
        setCurrentShape({ shape: 'line', startX: mouseX, startY: mouseY, endX: mouseX, endY: mouseY, current: true, strokeColor: 'black', strokeWidth: 2, slopiness: 0, strokeStyle: [0, 0] });
    }
    else if (shape === "hand") {
