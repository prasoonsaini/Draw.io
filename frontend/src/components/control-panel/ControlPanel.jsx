...
export function ControlPanel({ undo, redo, onZoom, scale, setScale }) {
    const canZoomOut = scale > 0.1; // For example, disallow zooming out below 10%
            ...
            <div className="controlPanel">
                <div className="zoomPanel">
                    <Tippy content="Zoom Out">
                        <button onClick={() => onZoom(-0.1)} aria-label="Zoom Out" disabled={!canZoomOut}>
                            <PiMinus />
                        </button>
                    </Tippy>
                    ...
                    <Tippy content="Zoom In">
                        <button onClick={() => onZoom(0.1)} aria-label="Zoom In" disabled={!canZoomIn}>
                            <PiPlus />
                        </button>
                    </Tippy>
                </div>
